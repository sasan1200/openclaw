...
const METHOD_SCOPE_GROUPS: Record<OperatorScope, readonly string[]> = {
  ...
  [WRITE_SCOPE]: [
    ...
    "operator.memory.promote",
    "operator.memory.upsertServiceContext",
    "operator.tasks.submit",
    "operator.tasks.dispatch",
    "operator.tasks.receipt",
    "operator.tasks.patch",
    "operator.worker.tasks.cancel",
  ],
  [ADMIN_SCOPE]: [
    "channels.logout",
    "agents.create",
